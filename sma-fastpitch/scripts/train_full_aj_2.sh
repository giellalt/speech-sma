...
: ${OUTPUT_DIR:="./output_full_aj_2"}
: ${LOG_FILE:=$OUTPUT_DIR/nvlog.json}
: ${DATASET_PATH:=anna_jacobsen_full_denoised}
: ${TRAIN_FILELIST:=filelists/anna-jacobsen-full-2-multispkr-pitch-shuf.txt}
: ${VAL_FILELIST:=filelists/anna-jacobsen-full-2-multispkr-pitch-shuf-val.txt}

...
: ${OUTPUT_DIR:="./output_sme"}
: ${LOG_FILE:=$OUTPUT_DIR/nvlog.json}
: ${DATASET_PATH:=acapela_m}
...
: ${TRAIN_FILELIST:=filelists/acapela_m_desc_tts_pitch_shuf.txt}
...
: ${VAL_FILELIST:=filelists/acapela_m_desc_tts_pitch_shuf_val.txt}
: ${AMP:=false} # voi laittaa true!
: ${SEED:=""}

...
: ${TRAIN_FILELIST:=filelists/smj_sander_text_noshorts2_shuff_pitch.txt}
...
: ${VAL_FILELIST:=filelists/smj_sander_text_noshorts2_shuff_pitch_val.txt}
: ${AMP:=false}
: ${SEED:=""}

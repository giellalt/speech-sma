...
def extract_descriptions(path):
    ...
    # target_folders_tts = [('sander_splits/',"sander_splits/")] #, ('speech-sme-tts/processed', "speech-sme-tts/processed"),]
    target_folders_tts = [('acapela_m/',"acapela_m/")] #, ('speech-sme-tts/processed', "speech-sme-tts/processed"),]
    # descriptions_asr = []
    descriptions_tts = []
...
if __name__ == '__main__':
    ...
    descriptions_tts = extract_descriptions('acapela_m/')
    print("Writing file...")
    # save_pipe_divided_file(descriptions_asr, 'speech-sme-asr/desc_asr.psv')
    save_pipe_divided_file(descriptions_tts, 'acapela_m/acapela_m_desc_tts.psv')
